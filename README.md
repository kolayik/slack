...
[![Build Status](https://travis-ci.org/Kolayik/slack.svg?branch=master)](https://travis-ci.org/Kolayik/slack)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/Kolayik/slack/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/Kolayik/slack/?branch=master)
...
* Laravel integration: [Slack for Laravel](https://github.com/Kolayik/slack-laravel)
...
```sh
composer require kolayik/slack
```
...
$client = new Kolayik\Slack\Client('https://hooks.slack.com/...');
...
$client = new Kolayik\Slack\Client('https://hooks.slack.com/...', $settings);
```
